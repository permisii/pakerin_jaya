                    ...
                    <div class="card-body">
                        @foreach ($assignments as $assignment)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control form-control form-control-sm"
                                        placeholder="NO PK" value="{{ $assignment->assignment_number }}" autocomplete="off"
                                        readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" placeholder="PENANGANAN" readonly rows="20">{{ $assignment->resolution }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" placeholder="KETERANGAN" readonly>{{ $assignment->description }}</textarea>
                                </div>
                            </div>
                        @endforeach

                        <h6 class="text-divider mb-4"><span>Pekerjaan Baru</span></h6>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label text-right">NO PK</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control form-control form-control-sm"
                                    placeholder="NOMOR PK" autocomplete="off" name="assignment_number">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label text-right">MASALAH</label>
                        ...
                        @if (!auth()->user()->is_admin)
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label text-right">PENANGANAN</label>
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" placeholder="PENANGANAN" rows="20" name="resolution"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label text-right">KETERANGAN</label>
                                <div class="col-sm-4">
                                    <textarea class="form-control" rows="3" placeholder="DESKRIPSI" rows="20" name="description"></textarea>
                                </div>
                            </div>
